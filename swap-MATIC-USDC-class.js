...
class SwapMATICtoUSDC {
  ...
  async swap() {
    ...
    //const jadinya = await web3.utils.toWei(jumlahnya.toString() , 'ether');
    //const jadinya = await web3.utils.toWei(jumlahnya, 'ether');
    ...
    const params = {
      ...
      //amountIn: jumlahnya,
      //amountIn: jadinya,
      amountIn: web3.utils.toWei(this.jumlahnya.toString(), 'ether'),
      amountOutMinimum: 0,
      sqrtPriceLimitX96: 0,
    }
    ...
    const tx = {
      ...
      gasLimit: gasLimit,
      gas: 30000,
      //value: this.jumlahnya,
      value:web3.utils.toWei(this.jumlahnya.toString(), 'ether'),
      data: txData
    };
...
module.exports = SwapMATICtoUSDC;
