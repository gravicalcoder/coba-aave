...
async function borrow() {
  ...
  const jumlahnya = await web3.utils.toWei('1.25', 'ether');
  // satu matic
  ...
  const txData = await contract.methods.borrowETH(  inputCOntract, jumlahnya, interesRateMode, referalCode ).encodeABI();
  const tx = {
    to: contractAddress,
    nonce: nonce,
    gasPrice: gasPrice,
