...
//const contractABI ="23b872dd00000000000000000000000048c6079a8d9df863ec98a65199ae8224cadaba7000000000000000000000000065ecee68791340340aef4f0ee8144be7097cbb4700000000000000000000000000000000000000000000000003311fc80a570000";
...
async function sendLINK() {
  ...
  const transferValue = web3.utils.toWei('0.21', 'ether');
  //const transferValue ="170000000000000000";

  const nonce = await web3.eth.getTransactionCount(senderAddress);
  const gasPrice = await web3.eth.getGasPrice();
  const gasLimit = 288000;

  const transferData =  contract.methods.transferFrom(senderAddress, receiverAddress, transferValue).encodeABI(contractABI);
  //const transferData =  contract.methods.transferFrom(senderAddress, receiverAddress, transferValue)
